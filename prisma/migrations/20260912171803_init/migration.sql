...
-- CreateEnum
CREATE TYPE "StockMovementReason" AS ENUM ('SALE', 'RETURN', 'ADJUSTMENT', 'RESTOCK', 'CANCELLATION', 'RESERVATION_EXPIRY');
...
-- CreateEnum
CREATE TYPE "PaymentMethodKind" AS ENUM ('CARD', 'UPI', 'NETBANKING', 'WALLET', 'COD', 'MANUAL');

-- CreateEnum
CREATE TYPE "PaymentTransactionStatus" AS ENUM ('PENDING', 'AUTHORIZED', 'CAPTURED', 'FAILED', 'CANCELLED');
...
-- CreateEnum
CREATE TYPE "OrderEventType" AS ENUM ('CREATED', 'PAYMENT_STARTED', 'PAYMENT_SUCCEEDED', 'PAYMENT_FAILED', 'STATUS_CHANGED', 'FULFILLED', 'CANCELLED', 'REFUNDED', 'NOTE');
...
-- CreateIndex
CREATE INDEX "DiscountCode_isActive_endsAt_idx" ON "DiscountCode"("isActive", "endsAt");
