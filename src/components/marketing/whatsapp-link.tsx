...
/** The WhatsApp option as a contact card, matching the email and phone tiles. */
export function WhatsAppLink() {
  ...
  return (
    <a
      ...
      className="rounded-lg border bg-surface p-5 transition-colors hover:border-border-strong sm:col-span-2"
    >
      <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden className="size-5 text-[#25D366]">
      ...
      <p className="mt-3 font-display text-lg">Message us on WhatsApp</p>
      <p className="mt-0.5 text-sm text-muted-foreground">
        Fastest way to reach us — sizing, stock and order questions.
      </p>
    </a>
  );
}
