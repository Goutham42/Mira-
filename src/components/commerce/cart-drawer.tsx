...
export function CartDrawer({ cart }: { cart: CartView }) {
  ...
  return (
    <Sheet open={open} onOpenChange={setOpen}>
      <SheetTrigger
        className="icon-action relative inline-flex items-center justify-center rounded-full p-2.5 text-foreground/80 hover:bg-surface-muted hover:text-primary"
      ...
      >
        ...
        <span
          aria-hidden
          className="absolute right-0.5 top-0.5 flex size-4.5 items-center justify-center rounded-full bg-primary text-[0.625rem] font-medium text-primary-foreground transition-transform duration-200 ease-[var(--ease-spring)]"
        >
